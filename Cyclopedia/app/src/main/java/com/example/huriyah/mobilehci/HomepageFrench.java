...
public class HomepageFrench extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view){
        if(view == timerButton){
            Intent intent = new Intent(HomepageFrench.this, TimerFrench.class);
            startActivity(intent);
        }
        if(view == clubButton){
            Intent intent = new Intent(HomepageFrench.this, CyclingClubsFrench.class);
            startActivity(intent);
        }
